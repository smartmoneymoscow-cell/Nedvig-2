"""SQLAlchemy models — shared between API and Scraper Worker."""
...
class AuctionProperty(Base):
    ...
    def to_dict(self) -> dict:
        ...
        return {
            "id": self.id,
            "source": _val(self.source),
            "source_id": self.source_id,
            "source_url": self.source_url,
            "title": self.title,
            "description": self.description,
            "property_type": _val(self.property_type),
            ...
            "auction_status": _val(self.auction_status),
